...
INSERT INTO app_user (name, email, password) VALUES
                                                 ('Amit Sharma', 'amit.sharma@example.com', 'password1'),
...
-- Applicants
INSERT INTO applicant (resume, is_first_session, user_id) VALUES
                                                              ('resume1.pdf', true, 1),
                                                              ('resume2.pdf', false, 2),
                                                              ('resume3.pdf', true, 3),
                                                              ('resume4.pdf', true, 4),
...
-- Employers
INSERT INTO employer (company_name, company_website, user_id) VALUES
                                                                  ('Tech Solutions', 'https://techsolutions.com', 1),
...
-- Jobs
INSERT INTO job (title, description, location, job_status, company, employer_id) VALUES
                                                                                     ('Software Engineer', 'Develop and maintain software applications.', 'Mumbai', 'OPEN', 'Tech Solutions', 1),
...
VALUES
    (1, 1, 'APPLIED', '2024-12-01 09:00:00'),
...
-- Mentors
INSERT INTO mentor (user_id, average_rating) VALUES
                                                 (1, 4.5),
                                                 (2, 4.8),
                                                 (3, 4.2),
                                                 (4, 4.6),
...
VALUES
    ('2024-12-01 09:00:00', '2024-12-01 10:00:00', null, '123456', 1, 1, 'FREE', 'COMPLETED', 'https://sessionlink1.com'),
    ('2024-12-02 11:00:00', '2024-12-02 12:00:00', 750.00, '654321', 2, 2, 'PAID', 'SCHEDULED', 'https://sessionlink2.com'),
    ('2024-12-03 13:00:00', '2024-12-03 14:00:00', 600.00, '654322', 3, 3, 'PAID', 'COMPLETED', 'https://sessionlink3.com'),
    ('2024-12-04 14:00:00', '2024-12-04 15:00:00', 450.00, '654323', 4, 4, 'PAID', 'SCHEDULED', 'https://sessionlink4.com'),
    ('2024-12-05 16:00:00', '2024-12-05 17:00:00', 800.00, '654324', 5, 5, 'PAID', 'COMPLETED', 'https://sessionlink5.com'),
    ('2024-12-06 18:00:00', '2024-12-06 19:00:00', 700.00, '654325', 6, 6, 'PAID', 'SCHEDULED', 'https://sessionlink6.com'),
    ('2024-12-07 10:00:00', '2024-12-07 11:00:00', 850.00, '654326', 7, 7, 'PAID', 'COMPLETED', 'https://sessionlink7.com'),
    ('2024-12-08 11:00:00', '2024-12-08 12:00:00', 400.00, '654327', 8, 8, 'PAID', 'SCHEDULED', 'https://sessionlink8.com'),
    ('2024-12-09 13:00:00', '2024-12-09 14:00:00', null, '654328', 9, 9, 'FREE', 'COMPLETED', 'https://sessionlink9.com'),
    ('2024-12-10 15:00:00', '2024-12-10 16:00:00', null, '654329', 10, 10, 'FREE', 'SCHEDULED', 'https://sessionlink10.com');

-- Payments
INSERT INTO payment (amount, payment_status, payment_time, session_id) VALUES
                                                                           (500.00, 'COMPLETED', '2024-12-01 12:00:00', 1),
...
INSERT INTO rating (rating_value, comment, session_id, mentor_id, applicant_id) VALUES
                                                                                    (4.5, 'Great session, learned a lot!', 1, 1, 1),
...
VALUES
    (500.00, 'DEBIT', 1, 'TXN123', 1, '2024-12-01 12:00:00'),
